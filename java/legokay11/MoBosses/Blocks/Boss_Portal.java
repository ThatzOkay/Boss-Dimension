package legokay11.MoBosses.Blocks;

import java.util.Random;

import legokay11.MoBosses.dimension.TeleporterBoss;
import legokay11.MoBosses.dimension.dimensionRegistry;
...
public class Boss_Portal extends BlockBreakable {
    ...
    {
    	Boss_Portal.Size size = new Boss_Portal.Size(worldIn, p_176548_2_, EnumFacing.Axis.X);
        ...
        {
        	Boss_Portal.Size size1 = new Boss_Portal.Size(worldIn, p_176548_2_, EnumFacing.Axis.Z);
    ...
    public void onNeighborBlockChange(World worldIn, BlockPos pos, IBlockState state, Block neighborBlock)
    {
        ...
        Boss_Portal.Size size;

        if (axis == EnumFacing.Axis.X)
        {
            size = new Boss_Portal.Size(worldIn, pos, EnumFacing.Axis.X);
        ...
        {
            size = new Boss_Portal.Size(worldIn, pos, EnumFacing.Axis.Z);
	...
	public void onEntityCollidedWithBlock(World world, int x, int y, int z, Entity entity){
		if(entity.ridingEntity == null && entity.riddenByEntity == null && entity instanceof EntityPlayerMP){
			...
			if(entity instanceof EntityPlayerMP){
				...
				}else if(thePlayer.dimension != dimensionRegistry.dimID){
					thePlayer.timeUntilPortal = 10;
					thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, dimensionRegistry.dimID, new TeleporterBoss(server.worldServerForDimension(dimensionRegistry.dimID)));
					
				}else{
					thePlayer.timeUntilPortal = 10;
					thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, 0, new TeleporterBoss(server.worldServerForDimension(0)));
				}
    ...
    public static class Size
        {
            ...
            protected int func_180120_a(BlockPos p_180120_1_, EnumFacing p_180120_2_)
            {
                ...
                for (i = 0; i < 22; ++i)
                {
                    ...
                    if (!this.func_150857_a(this.world.getBlockState(blockpos1).getBlock()) || this.world.getBlockState(blockpos1.down()).getBlock() != InitBlocks.Xonim_block)
                    {
                        break;
                    }
                }
                ...
                return block == InitBlocks.Xonim_block ? i : 0;
            }
            ...
            protected int func_150858_a()
            {
                ...
                for (this.field_150862_g = 0; this.field_150862_g < 21; ++this.field_150862_g)
                {
                    for (i = 0; i < this.field_150868_h; ++i)
                    {
                        ...
                        if (block == InitBlocks.Boss_portal)
                        {
                            ++this.field_150864_e;
                        }
                        ...
                        if (i == 0)
                        {
                            ...
                            if (block != InitBlocks.Xonim_block)
                            {
                                break label56;
                            }
                        }
                ...
                for (i = 0; i < this.field_150868_h; ++i)
                {
                    if (this.world.getBlockState(this.field_150861_f.offset(this.field_150866_c, i).up(this.field_150862_g)).getBlock() != InitBlocks.Xonim_block)
                    {
            ...
            {
                return p_150857_1_.getMaterial() == Material.air || p_150857_1_ == Blocks.fire || p_150857_1_ == InitBlocks.Boss_portal;
            }
            ...
            public void func_150859_c()
            {
                for (int i = 0; i < this.field_150868_h; ++i)
                {
                    ...
                    {
                        this.world.setBlockState(blockpos.up(j), InitBlocks.Boss_portal.getDefaultState().withProperty(BlockPortal.AXIS, this.axis), 2);
                    }
                }
            }
        }
